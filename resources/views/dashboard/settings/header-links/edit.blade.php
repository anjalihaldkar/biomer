...
@php
    ...
    $subTitle = 'Update navigation menu item';
@endphp
...
@section('content')
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    <div>
      <h6 class="mb-0">✏️ Edit Header Link</h6>
      <small class="text-muted">{{ $headerLink->label }}</small>
    </div>
        ...
        <div class="row g-3 mb-3">
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror"
                   value="{{ old('icon', $headerLink->icon) }}" placeholder="e.g., lucide:home, ri-home-line">
