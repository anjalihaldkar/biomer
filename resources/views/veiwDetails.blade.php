                        ...
                        <div class="card-body p-0">
                            <div class="py-16 px-24 border-bottom">
                                <div class="d-flex align-items-start gap-3">
                                    <img src="{{ asset('assets/imagess/user-list/user-list1.png') }}" alt="" class="w-40-px h-40-px rounded-pill">
                                    <div class="">
                            ...
                            <div class="py-16 px-24 border-bottom">
                                <div class="d-flex align-items-start gap-3">
                                    <img src="{{ asset('assets/imagess/user-list/user-list2.png') }}" alt="" class="w-40-px h-40-px rounded-pill">
                                    <div class="">
                                        <div class="d-flex align-items-center flex-wrap gap-2">
